 ...
 * @return string
 */
function csuf_framework_user_settings($css, $theme) {
    ...
    $css = csuf_framework_set_fontsizereference($css, $fontsizereference);
    ...
    $css = csuf_framework_set_framemargin($css, $framemargin);
    ...
    $css = csuf_framework_set_headerbgc($css, $headerbgc);
    ...
    $css = csuf_framework_set_blockcontentbgc($css, $blockcontentbgc);
    ...
    $css = csuf_framework_set_lblockcolumnbgc($css, $lblockcolumnbgc);
    ...
    $css = csuf_framework_set_rblockcolumnbgc($css, $rblockcolumnbgc);
    ...
    $css = csuf_framework_set_blockcolumnwidth($css, $blockcolumnwidth);
    ...
    $css = csuf_framework_set_blockpadding($css, $blockcolumnwidth, $blockpadding);
    ...
    $css = csuf_framework_set_customcss($css, $customcss);
 ...
 *
 */
function csuf_framework_set_fontsizereference($css, $fontsizereference) {
    $tag = '[[setting:fontsizereference]]';
    $css = str_replace($tag, $fontsizereference.'px', $css);
    return $css;
}

function csuf_framework_set_framemargin($css, $framemargin) {
...
function csuf_framework_set_headerbgc($css, $headerbgc) {
    $tag = '[[setting:headerbgc]]';
    $css = str_replace($tag, $headerbgc, $css);
    return $css;
}

function csuf_framework_set_blockcontentbgc($css, $blockcontentbgc) {
    $tag = '[[setting:blockcontentbgc]]';
    $css = str_replace($tag, $blockcontentbgc, $css);
    return $css;
}

function csuf_framework_set_lblockcolumnbgc($css, $lblockcolumnbgc) {
    $tag = '[[setting:lblockcolumnbgc]]';
    $css = str_replace($tag, $lblockcolumnbgc, $css);
    return $css;
}

function csuf_framework_set_rblockcolumnbgc($css, $rblockcolumnbgc) {
    $tag = '[[setting:rblockcolumnbgc]]';
    $css = str_replace($tag, $rblockcolumnbgc, $css);
    return $css;
}

function csuf_framework_set_blockcolumnwidth($css, $blockcolumnwidth) {
...
function csuf_framework_set_blockpadding($css, $blockcolumnwidth, $blockpadding) {
...
function csuf_framework_set_customcss($css, $customcss) {
    $tag = '[[setting:customcss]]';
    $css = str_replace($tag, $customcss, $css);
    return $css;
}

function theme_csuf_framework_page_init(moodle_page $page) {
    // always add css first, add/define more jQuery in the jquery/plugins.php
    $page->requires->jquery_plugin('ui-css', 'core');
    $page->requires->jquery_plugin('fancybox-css', 'theme_csuf_framework');
    $page->requires->jquery_plugin('confirm-css-style', 'theme_csuf_framework');
    $page->requires->jquery_plugin('confirm-css', 'theme_csuf_framework');

    $page->requires->jquery();
    $page->requires->jquery_plugin('ui', 'core');
    $page->requires->jquery_plugin('fancybox', 'theme_csuf_framework');
    $page->requires->jquery_plugin('confirm', 'theme_csuf_framework');
    $page->requires->jquery_plugin('myjquery', 'theme_csuf_framework');
