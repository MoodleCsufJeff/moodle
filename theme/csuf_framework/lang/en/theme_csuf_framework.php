...
/**
 * Strings for component 'theme_csuf_framework', language 'en', branch 'MOODLE_20_STABLE'
 *
...
<div class="clearfix">
    <div class="theme_screenshot">
        <h2>CSUF Framework</h2>
        <img src="csuf_framework/pix/screenshot.gif" />
    ...
    <div class="theme_description">
        <h2>About</h2>
        <p>CSUF Framework is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
        <h2>Tweaks</h2>
    ...
    <h2>Credits</h2>
    <p>This theme was coded and is maintained by Jeff Wang. </p>
        <h2>License</h2>
...
$string['configtitle'] = 'CSUF Framework theme';
...
$string['noframe'] = 'CSUF Framework 0.1 look';
...
$string['pluginname'] = 'CSUF Framework';
